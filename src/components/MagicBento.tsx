...
const GlobalSpotlight: React.FC<{
  ...
  useEffect(() => {
    ...
    const processMousePosition = (event: MouseEvent | null) => {
    ...
    const handleScroll = () => {
      ...
      processMousePosition(lastMouseEvent.current);
    };
...
const MagicBento: React.FC<BentoProps> = ({
  ...
  const cards: BentoCardProps[] =
    items && items.length > 0 ? items : defaultCardData;
      ...
      <style>
        {`
          ...
          .card--border-glow:hover {
            box-shadow: 0 4px 20px rgba(0, 0, 0, 0.45), 0 0 30px rgba(${glowColor}, 0.2);
          }
          ...
          .particle-container:hover {
            box-shadow: 0 4px 20px rgba(0, 0, 0, 0.35), 0 0 30px rgba(${glowColor}, 0.2);
          }
                ...
                <div className="card__content flex flex-col gap-6 relative text-white">
                  ...
                  {card.href && (
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="inline-flex items-center text-xs font-semibold text-white transition hover:text-gray-200"
                    >
                      View more ↗
                    </a>
                  )}
