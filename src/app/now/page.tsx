...
const building = [
  {
    ...
    description: "AI-powered learning and career prep platform. Working on the developer experience and onboarding flows.",
    status: "Active",
  },
  {
    name: "LifeXP",
    href: "https://lifexp.live",
    description: "Gamified life experience tracker. Iterating on the progression system and data visualisations.",
    status: "Active",
  },
];
    ...
    <main className="min-h-screen bg-black text-white">
      <div className="mx-auto max-w-2xl px-6 py-20 space-y-16">
        ...
        <div className="space-y-2">
          <p className="text-xs uppercase tracking-[0.3em] text-white/40">Now</p>
        ...
        <div className="space-y-4">
          <h2 className="text-xs uppercase tracking-[0.25em] text-white/50">Currently building</h2>
            ...
            {building.map((project) => (
              ...
              >
                <div className="flex items-center justify-between">
                  <span className="font-semibold group-hover:text-white/90">{project.name}</span>
                  <div className="flex items-center gap-2">
                    <span className="rounded-full border border-emerald-500/30 px-2 py-0.5 text-xs text-emerald-400">
                      {project.status}
                    </span>
                    <ExternalLink size={13} className="text-white/30 group-hover:text-white/60 transition" />
                  </div>
                </div>
        ...
        {/* GitHub graph */}
        <div className="space-y-4">
          <h2 className="text-xs uppercase tracking-[0.25em] text-white/50">GitHub activity</h2>
        ...
        {/* Reading */}
        <div className="space-y-4">
          <h2 className="text-xs uppercase tracking-[0.25em] text-white/50">Reading</h2>
          <ul className="space-y-2">
            {reading.map((book) => (
              <li key={book} className="flex items-start gap-3 text-sm text-white/60">
        ...
        {/* Obsessed with */}
        <div className="space-y-4">
          <h2 className="text-xs uppercase tracking-[0.25em] text-white/50">Obsessed with</h2>
          <ul className="space-y-2">
            {obsessed.map((item) => (
